...
class TestGpuCollector(unittest.TestCase):
    ...
    def test_fetch_parses_nvidia_smi_output(self, mock_run):
        ...
        self.assertAlmostEqual(float(sensors_shiro.GpuCollector._cache[0]['power']), 250.5)
        self.assertAlmostEqual(float(sensors_shiro.GpuCollector._cache[0]['power_limit']), 350.0)
